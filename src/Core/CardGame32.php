...
class CardGame32
{
  ...
  public static function compare(Card $c1, Card $c2) : int
  {
    ...
    $orders_colors = ['carreau'=>4 , 'pique'=>3 , 'coeur'=>2 , 'trèfle'=>1];
    $orders_name = ['as'=>13 , '2'=>1 , '3'=>2 , '4'=>3, '5'=>4, '6'=>5, '7'=>6, '8'=>7, '9'=>8, '10'=>9, 'valet'=>10, 'dame'=>11, 'roi'=>12];
    ...
    if ($orders_name[$c1Name] === $orders_name[$c2Name]) {
        if ($orders_colors[$c1Color] === $orders_colors[$c2Color])
          return 0;
        else
          return ($orders_colors[$c1Color] > $orders_colors[$c2Color]) ? +1 : -1;
    }
 ...
 // TODO manque PHPDoc
  public static function factoryCardGame32() : CardGame32 {
     ...
     //, new Card('As', 'Pique'), new Card('2', 'Pique')
